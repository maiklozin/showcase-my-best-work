...
export const translations: Record<Language, TranslationKeys> = {
  en: {
    heroSubtitle: "Fashion Model in Mallorca",
    heroCategories: "Editorial / Commercial / Runway / Bridal",
    viewPortfolio: "View Portfolio ↓",
    portfolioLabel: "Selected Works",
    portfolioTitle: "Portfolio",
    contactLabel: "Contact",
    contactTitle: "Bookings & Collaborations",
    contactDescription: "Available for editorial, commercial, bridal, runway, and branded content bookings in Mallorca, Palma de Mallorca, Spain, and Europe.",
    ...
    aboutBio: "Fashion model based in Mallorca with 6+ years of experience across editorials, commercial campaigns, runway shows, brand content, and advertising productions in Spain.",
    ...
    aboutTravel: "Based in Mallorca and available in Palma de Mallorca, across Spain, and for select projects in Europe.",
    ...
    bookingRequestDates: "Send Request",
  ...
  es: {
    ...
    bookingRequestDates: "Enviar solicitud",
  ...
  de: {
    ...
    bookingRequestDates: "Anfrage senden",
  ...
  fr: {
    ...
    bookingRequestDates: "Envoyer la demande",
  ...
  ru: {
    ...
    bookingRequestDates: "Отправить запрос",
